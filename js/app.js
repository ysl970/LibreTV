// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["ruyi","ffzy","lzzy","bfzy","qiqikp","heimuer","mdzy","wolong","tyyszy","ikunzy","zy360","wujin","zuida","jisu","dbzy","subo"]'); // 默认选中黑木耳和豆瓣资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 仅选择黑木耳源和豆瓣资源
        selectedAPIs = ["ruyi","ffzy","lzzy","bfzy","qiqikp","heimuer","mdzy","wolong","tyyszy","ikunzy","zy360","wujin","zuida","jisu","dbzy","subo"];
