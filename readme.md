...
选择以下任一平台，点击一键部署按钮，即可快速创建自己的 YTPPTV 实例：

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FLibreSpark%2FYTPPTV) [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/LibreSpark/YTPPTV) 

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/LibreSpark/YTPPTV) 
...
services:
  YTPPTV:
    image: bestzwei/YTPPTV:latest
    container_name: YTPPTV
    ports:
      - "8899:80"
    environment:
      - PASSWORD=111111
...
要为您的 YTPPTV 实例添加密码保护，可以在部署平台上设置环境变量：
